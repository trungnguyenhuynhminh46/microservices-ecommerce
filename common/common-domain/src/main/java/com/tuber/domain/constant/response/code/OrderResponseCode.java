...
public class OrderResponseCode extends ResponseCodeBase {
    ...
    public static final OrderResponseCode INVENTORY_CONFIRMATION_OUTBOX_MESSAGE_NOT_FOUND = new OrderResponseCode(1015, "Inventory confirmation outbox message with saga id: %s could not be found!");
    public static final OrderResponseCode PAYMENT_OUTBOX_MESSAGE_NOT_FOUND = new OrderResponseCode(1016, "Payment outbox message with saga id: %s and saga status: %s could not be found!");
